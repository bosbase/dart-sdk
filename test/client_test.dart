...
void main() {
  group("Bosbase()", () {
    test("with defaults", () {
      final client = Bosbase("https://example.com");
  ...
  group("Bosbase.getFileUrl()", () {
    test("retrieve encoded record file url", () {
      final client = Bosbase("/base/");
