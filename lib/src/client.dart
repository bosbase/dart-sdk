...
class Bosbase {
  ...
  /// The Bosbase backend base url address (eg. 'http://127.0.0.1:8090').
  String baseURL;
  ...
  /// Note: this method needs to be called only when the Bosbase
