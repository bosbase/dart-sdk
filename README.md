Bosbase Dart SDK [![Pub Package](https://img.shields.io/pub/v/bosbase.svg)](https://pub.dev/packages/bosbase)
======================================================================

Official Multi-platform Dart SDK for interacting with the [Bosbase Web API](https://bosbase.io/docs).
...
```sh
dart pub add bosbase

# or with Flutter:
flutter pub add bosbase
```
...
> More detailed API docs and copy-paste examples could be found in the [API documentation for each service](https://bosbase.io/docs/api-authentication)
...
Bosbase Dart SDK handles file upload seamlessly by using `http.MultipartFile` list.
...
You could find more detailed documentation in the [`RecordModel` class reference](https://pub.dev/documentation/bosbase/latest/bosbase/RecordModel-class.html),
...
The defaults should work fine for most applications but in some situations you may benefit from utilizing persistent connections when sending requests to your Bosbase server _(~10% improvement on average when sending 100 requests)_.
...
final pb = Bosbase('http://127.0.0.1:8090', reuseHTTPClient: true);
...
#### RecordService ([Detailed class reference](https://pub.dev/documentation/bosbase/latest/bosbase/RecordService-class.html), [API docs](https://bosbase.io/docs/api-records))
...
##### FileService ([Detailed class reference](https://pub.dev/documentation/bosbase/latest/bosbase/FileService-class.html))
...
#### LogService ([Detailed class reference](https://pub.dev/documentation/bosbase/latest/bosbase/LogService-class.html), [API docs](https://bosbase.io/docs/api-logs))
...
#### SettingsService ([Detailed class reference](https://pub.dev/documentation/bosbase/latest/bosbase/SettingsService-class.html), [API docs](https://bosbase.io/docs/api-settings))
...
#### RealtimeService ([Detailed class reference](https://pub.dev/documentation/bosbase/latest/bosbase/RealtimeService-class.html), [API docs](https://bosbase.io/docs/api-realtime))
...
##### BackupService ([Detailed class reference](https://pub.dev/documentation/bosbase/latest/bosbase/BackupService-class.html), [API docs](https://bosbase.io/docs/api-backups))
...
##### CronService ([Detailed class reference](https://pub.dev/documentation/bosbase/latest/bosbase/CronService-class.html), [API docs](https://bosbase.io/docs/api-crons))
...
##### HealthService  ([Detailed class reference](https://pub.dev/documentation/bosbase/latest/bosbase/HealthService-class.html), [API docs](https://bosbase.io/docs/api-health))
...
Bosbase Dart SDK is built on top of the standard `dart-lang/http` package and inherits some of its limitations:
